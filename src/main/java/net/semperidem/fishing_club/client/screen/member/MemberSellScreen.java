...
import net.semperidem.fishing_club.network.payload.SellFishPayload;
...
import static net.semperidem.fishing_club.client.screen.member.MemberBuyScreen.OFFER_TEXTURE;
import static net.semperidem.fishing_club.client.screen.member.MemberScreen.BEIGE_TEXT_COLOR;
import static net.semperidem.fishing_club.client.screen.member.MemberScreen.TILE_SIZE;
    ...
    private class EntriesGridWidget extends MemberScrollableWidget {
        ...
        public int getTotalAvailable() {
            ...
            for(GridEntry entry : entries) {
                    total += entry.itemStack.getOrDefault(FCComponents.FISH, FishRecord.DEFAULT).value();
            }
            return total;
        }
