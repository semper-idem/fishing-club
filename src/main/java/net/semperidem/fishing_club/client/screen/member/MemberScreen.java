...
import net.semperidem.fishing_club.client.screen.dialog.PlayerFaceComponent;
import net.semperidem.fishing_club.screen.member.MemberScreenHandler;

import static net.semperidem.fishing_club.util.TextUtil.drawOutlinedTextRightAlignedTo;
import static net.semperidem.fishing_club.util.TextUtil.drawTextRightAlignedTo;
