package net.semperidem.fishing_club.fisher.level_reward;

import net.minecraft.item.ItemStack;
import net.minecraft.item.Items;
import net.semperidem.fishing_club.fisher.level_reward.LevelReward.Amount;
import net.semperidem.fishing_club.registry.FCItems;

import java.util.ArrayList;
import java.util.List;

import static net.semperidem.fishing_club.fisher.level_reward.LevelReward.*;
