...
public class FCFeatures {
	public static final Identifier REED_FEATURE_ID = FishingClub.identifier("reed_feature");
	...
	public static final Identifier DUCKWEED_FEATURE_ID = FishingClub.identifier("duckweed_feature");
