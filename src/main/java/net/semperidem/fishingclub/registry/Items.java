...
public class Items {
    ...
    public static void register() {
        registerParts();
        DOUBLE_FISHING_NET = registerItem(("double_fishing_net"), new FishingNetItem(new Item.Settings().maxCount(1).component(Components.FISHING_NET_CONTENT, FishingNetContentComponent.DEFAULT), 4));
        FISHING_NET = registerItem(("fishing_net"), new FishingNetItem(new Item.Settings().maxCount(1).component(Components.FISHING_NET_CONTENT, FishingNetContentComponent.DEFAULT), 2));
        ...
        TACKLE_BOX = registerItem("tackle_box", new TackleBoxItem(Blocks.TACKLE_BOX_BLOCK, new Item.Settings()));
        FISH_DISPLAY_BAMBOO = registerItem("fish_display_bamboo", new FishDisplayItem(Blocks.FISH_DISPLAY_BLOCK_BAMBOO, new Item.Settings().maxCount(16)));
        ...
        REED = registerItem("reed", new BlockItem(Blocks.REED_BLOCK, new Item.Settings()));
        ENERGY_DENSE_KELP = registerItem("energy_dense_kelp", new BlockItem(Blocks.ENERGY_DENSE_KELP, new Item.Settings()));
        DRIED_ENERGY_DENSE_KELP = registerItem("dried_energy_dense_kelp", new Item(new Item.Settings()));
        DRIED_ENERGY_DENSE_KELP_BLOCK = registerItem("dried_energy_dense_kelp_block", new BlockItem(Blocks.DRIED_ENERGY_DENSE_KELP_BLOCK, new Item.Settings()));
        NUTRITIOUS_KELP = registerItem("nutritious_kelp", new BlockItem(Blocks.NUTRITIOUS_KELP, new Item.Settings().food(NUTRITIOUS_KELP_FOOD)));
        DRIED_NUTRITIOUS_KELP = registerItem("dried_nutritious_kelp", new Item(new Item.Settings().food(DRIED_NUTRITIOUS_KELP_FOOD)));
        DRIED_NUTRITIOUS_KELP_BLOCK = registerItem("dried_nutritious_kelp_block", new BlockItem(Blocks.DRIED_NUTRITIOUS_KELP_BLOCK, new Item.Settings()));
        DUCKWEED = registerItem("duckweed", new DuckweedItem(Blocks.DUCKWEED_BLOCK, new Item.Settings()));
...
//              Comparator.comparing(o -> o.getName().getString(), String.CASE_INSENSITIVE_ORDER)).toList()
    ...
    public static void registerLineEarly() {
        LINE_SPIDER = Items.registerItem("line_spider", new LinePartItem(new Item.Settings().rarity(COMMON))
                .weightClass(2)
                .minOperatingTemperature(-1)
                .maxOperatingTemperature(1)
                .maxLineLength(16)
