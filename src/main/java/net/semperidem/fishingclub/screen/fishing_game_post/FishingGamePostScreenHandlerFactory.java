...
public class FishingGamePostScreenHandlerFactory implements ExtendedScreenHandlerFactory<FishingGamePostS2CPayload> {
    ...
    public FishingGamePostScreenHandlerFactory(SpecimenData fish) {
        this.fish = fish;
    }
    ...
    return new FishingGamePostScreenHandler(syncId, inv, new FishingGamePostS2CPayload(this.fish));
    }

    @Override
    public FishingGamePostS2CPayload getScreenOpeningData(ServerPlayerEntity player) {
        return new FishingGamePostS2CPayload(this.fish);
    }
}