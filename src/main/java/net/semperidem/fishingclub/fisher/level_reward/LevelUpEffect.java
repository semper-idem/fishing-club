...
public interface LevelUpEffect {
    ...
    default void executeFor(ServerPlayerEntity serverPlayer) {
        this.execute(serverPlayer.getServerWorld(), serverPlayer.getX(), serverPlayer.getY() - 1.5, serverPlayer.getZ());
    }
